...
export default function Tasks() {
  ...
  const addTask = () => {
    ...
    setTasks(ts => [...ts, {
      id: Date.now(), title: quickAdd.trim(), done: false,
            ...
            >
              <label className="flex items-start gap-3 px-4 py-3.5 cursor-pointer">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <ChevronDown size={12} className="text-[var(--muted-foreground)] opacity-0 group-hover:opacity-100 transition-opacity" />
                </div>
              </label>
            </div>
          ))}
