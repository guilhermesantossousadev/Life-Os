      ...
      >
        <div className="flex items-center gap-3 px-4 py-3 border-b border-[var(--border)]">
          ...
          <input
            ...
            aria-label="Pesquisar em todos os módulos"
        ...
        <div className="py-2 max-h-80 overflow-y-auto" aria-live="polite">
            ...
            return (
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 text-left ${
                  active === index ? "bg-[var(--secondary)]" : ""
                }`}
              >
                <div className="w-7 h-7 rounded-md bg-[var(--accent)] text-[var(--primary)] flex items-center justify-center">
                  <Icon size={13} />
                </div>
                <div>
                  <p className="text-[13.5px]">{result.title}</p>
          ...
          {loading && (
            <p className="text-center text-sm py-8">Pesquisando...</p>
          )}
          {!loading && query.length >= 2 && results.length === 0 && (
            <p className="text-center text-sm py-8 text-[var(--muted-foreground)]">
