            ...
            >
              <label className="flex items-start gap-3 px-4 py-3.5 cursor-pointer">
                ...
                <div className="flex items-center gap-2 flex-shrink-0">
                  ...
                  <button aria-label="Editar tarefa" onClick={event => { event.preventDefault(); setEditing(editing === task.id ? null : task.id); }} className="opacity-0 group-hover:opacity-100 p-1 text-[var(--muted-foreground)] hover:text-[var(--primary)]"><Pencil size={12} /></button>
